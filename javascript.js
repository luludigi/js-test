...
// selectors - assign variables to a select value so we can use it again later.
...
// functions - .inner text will make the value appears on the page.
...
function addExpense(event) {
    ...
    let newExpense = document.createElement('p'); //create a element call parapgraph
...
function updateExpenseTotal() {
    expenseTotal = 0;
    for (let i = 0; i < expenses.length; i++) {  //loop will run until end of the arry (no more values)
